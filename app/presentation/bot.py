...
async def how_cmd(msg: Message):
    ...
    **Что модель теперь учитывает:**
        • Уход в другой вуз, когда он уже виден: код поступающего единый для всех вузов, а согласие можно держать только одно. Если человек подал согласие в другой вуз, модель почти наверняка уводит его отсюда — и место достаётся следующему.
        • Уход тех, кто не подал согласие нигде, — здесь по-прежнему сценарная оценка, а не знание чужих планов.
