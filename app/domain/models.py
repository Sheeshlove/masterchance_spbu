...
class ProgramCompetition:
    ...
    сильнее, у скольких балла ещё нет, сколько конкурентов сидят без согласия
    ...
    unscored_rivals: int         # соперников, у которых балла ещё нет
    rivals_without_consent: int  # соперников без согласия НИГДЕ — пул оттока MC
    my_priority: int | None
    my_total_score: int | None   # 0/None → балла ещё нет
    my_consent: bool
