...
.PHONY: build push all clean help run run-web run-bot run-desktop seed seed-spbgu snapshot publish-snapshot server-update exe test web-docker compose-up compose-down version bump-version
